...
class Clothing extends Product {
  ...
  constructor(productDetails){
    super(productDetails); //call constructor of parent class, tako da mi ne moramo jedan po,jedan pisati. Vazno za znati ako ne kreiramo konstruktor po defaultu ce se pokrenuti parent konstruktor
    this.sizeChartLink = productDetails.sizeChartLink;
  }

  extraInfoHTML() { //methodOveriding
    //super.extraInfoHTML();
    return `
